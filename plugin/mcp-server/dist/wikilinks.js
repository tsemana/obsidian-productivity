...
export function canonicalWikilink(filename, displayName) {
 ...
 */
export function buildAliasPattern(aliases) {
 ...
 */
export function consolidateWikilinks(content, canonicalFilename, displayName, aliases) {
